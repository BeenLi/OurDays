...
| [calendar-ux-fixes](plans/calendar-ux-fixes/) | ✅ 基本完成 | 3 phase 代码落地 + 两真机 e2e 跑通（joint 评论对称 + 邀请跨设备）；剩肉眼/离线分支可选验 | 2026-06-20：扩展 smoke `SMOKE3_EXIT=0 ✅ PASS`（joint 评论 owner↔partner 同串）+ 全量单测 | （可选）周视图 joint 点击 Deferred；离线乐观自愈分支单独验 |
